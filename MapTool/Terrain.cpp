...
_bool CTerrain::IsPicking(_float3* pOut)
{
	return m_pVIBufferCom->isPicking(m_pTransformCom->GetWorldMat(), pOut);
}
...
HRESULT CTerrain::Ready_Components()
{
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Brush"),
		TEXT("Com_Navigation"), reinterpret_cast<CComponent**>(&m_pBrushTextureCom))))
		return E_FAIL;
