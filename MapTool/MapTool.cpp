    ...
    _In_ int       nCmdShow)
{
    ...
    //SetWindowPos(g_hWnd, g_hWnd, 0, 0, g_iWinSizeX, g_iWinSizeY, 0);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = NULL;//MAKEINTRESOURCEW(IDC_MAPTOOL);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    AdjustWindowRect(&rcWindowed, WS_OVERLAPPEDWINDOW, TRUE);//WS_OVERLAPPEDWINDOW, FALSE);
